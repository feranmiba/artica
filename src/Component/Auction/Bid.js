       ...
       <section class='flex justify-center transistion duration-150'>
        ...
        <div class='text-black'>
                <div class='flex justify-between py-5 text-3xl'>
                    ...
                    <span><FaWindowClose onClick={close}/></span>
                </div>
                <div class='flex justiify-center gap-10 flex-wrap md:flex-nowrap'>
                  <p class='w-full md:w-[45%]'><img src={imag} alt="" class='w-full'/></p>
                  <div>
                    <h1 class='text-3xl'>{ite}</h1>
                    <p class='text-xl pt-2'> <b>Art</b> by {myname}</p>
                    <span class='flex justify-between pt-3 pb-3'>
                      ...
                      <span>
                        <h1>Live Price</h1>
                        <p class='text-xl text-[#9747ff] font-semibold'>{priced}ETH</p>

                      </span>
                    </span>

                    <p class='border px-6 rounded-xl'><input type="text" placeholder='0.00' class='py-3 border-r text-xl'/>  ETH </p>
                    <p class='flex justify-between py-2'><FaHeart /> <button class='rounded-2xl px-14 text-xl py-3 bg-black text-white' onClick={close}>Make a bid</button></p>
                  </div>
                </div>

              <div class='flex mt-5 gap-10 bg-gray-200 p-2 rounded-2xl'>
                <span class='flex text-lg'> <img src={people} alt="" /> 4 people</span>
                <span class='flex text-lg'> <img src={price} alt="" /> 7 listen</span>
                </div>
