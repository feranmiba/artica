    ...
    <div class='mt-10'>
        <section>
            ...
            <div class='flex flex-wrap mt-2 justify-center'>
              { dat.map(InIt => {  return(< div class='group mt-10' onClick={() => setShowAdd(true) }> 
                <p> <img src={InIt.img} alt="" class=' border rounded-md w-10/12 group-hover:rounded-sm' onClick={()=> setImg(InIt.img)}/></p>
